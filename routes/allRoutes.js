...
router.get("/posts/:custom", (req, res) => {
  if (req.session.username) {
...
router.post("/posts/:custom", (req, res) => {
...
router.get("/update/:custom", (req, res) => {
  if (req.session.username) {
...
router.get("/delete/:custom", (req, res) => {
  if (req.session.username) {
...
router.get("/profile/:customRoute", (req, res) => {
  if (req.session.username) {
...
router.get("/editprofile/:custom", (req, res) => {
  if (req.session.username) {
...
router.get("/removeuser/:custom", (req, res) => {
  if (req.session.type === "admin") {
...
router.get("/:custom/:custom2", (req, res) => {
  res.render("notfound");
});
